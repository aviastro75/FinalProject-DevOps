# Security Group for EC2 Instances (Kubernetes nodes)
resource "aws_security_group" "k8s_nodes" {
  ...
  # NodePort Services - Allow from anywhere (like reference setup)
  ingress {
    from_port   = 30000
    to_port     = 32767
    protocol    = "tcp"

...
Manual run steps:
Make sure all secrets from section 4 are configured.
Go to the Actions tab in GitHub.
Select CI/CD Pipeline - Deploy Jewelry Shop.
...
Wait until all jobs finish (~25-35 minutes for full deployment).
Automatic run:
...
Scroll to Job 5: Helm Deployment → Step: Get service endpoint.
